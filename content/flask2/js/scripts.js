(function ($) {
    ...
    function mouseCursor() {
        ...
        if (pageCursor == true) {
            ...
            function cursorHovers() {
                ...
                var projectHovers = $('.ar-work, .fw-project, .cs-title, .sl-project, .wall-project, .Flask-single-project, .aw-project');
                ...
                var dotHovers = $('ul.main-menu a, .a-button, .a-client, .fs-button, .Flask-latest-posts .post, .field-wrap');
    ...
    function FlaskShop() {
        ...
        // init Masonry
        var $grid = $('.Flask-products-wrapper').masonry({
    ...
    function FlaskProductsCarousel() {

        var apCarousel = $('.Flask-products-carousel');
    ...
    function FlaskAwards() {

        var awards = $('.Flask-awards')
    ...
    function alitohServicesS1() {
        ...
        var services = $('.Flask-services.style_1'),
    ...
    function FlaskServicesS2() {

        if ($('.Flask-services').length) {

            let FlaskSer2 = $('.Flask-services.style_2'),
                service = FlaskSer2.find('.service'),
                willanim = FlaskSer2.data('anim');
    ...
    function FlaskPersonalHead() {

        let aph = $('.Flask-personal-head');
    ...
    function FlaskImageCarousel() {

        var aiCarousel = $('.Flask-image-carousel');
    ...
    function FlaskSingleProject() {

        var swProject = $('.Flask-single-project');
    ...
    function FlaskPageNav() {

        $('.Flask-page-nav').each(function () {
    ...
    function FlaskClients() {

        var clients = $('.Flask-clients');
    ...
    function FlaskSeperator() {

        let seperator = $('.Flask-seperator');
    ...
    function FlaskEmbedVideo() {


        if ($('.Flask-embed-video').length > 0) {

            var aEmbedVideo = $('.Flask-embed-video');
    ...
    function FlaskHeading() {

        var heading = $('.Flask-heading');
    ...
    function FlaskTeamCarousel() {

        var FlaskTeam = $('.Flask-team');

        FlaskTeam.each(function () {
    ...
    function FlaskShowcaseFullscrenSlider() {
    ...
    function FlaskShowcaseCarousel() {
    ...
    function FlaskScrollAnimations() {
    ...
    function initPages() {
        ...
        if ($('.Flask-blog').length) {

            FlaskBlog();

        }

        if ($('.Flask-works').length) {
    ...
    var trans = $('.Flask-page-transitions'),
                        ...
                        if (siteHeader.hasClass('menu-has-open')) {
                            ...
                            fsMenuTrans.fromTo('.trans_char', .75, {
                                ...
                                onStart: function () {
                                    ...
                                    if ($('.Flask-page-transitions').hasClass('dark')) {
                                        var firstColor = 'hsla(0, 0%, 100%, .2)',
                                            secondColor = '#fff';
                                    } else {
                                        var firstColor = 'rgba(25,27,29,.6)',
